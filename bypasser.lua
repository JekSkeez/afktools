...
function imgui.OnDrawFrame()
	if state.v then
		...
		imgui.Text(u8'                                                                    ')
        imgui.SameLine()
        imgui.Checkbox(u8'Отображать пикапы', showPickups)
        imgui.SameLine()
        imgui.Checkbox(u8'Логгировать в консоли нажатые текстдравы', logTextdraws)
        imgui.Text(u8'                                                                    ')
		imgui.SameLine()
		if imgui.Button(u8'Выйти из спектатора', imgui.ImVec2(240, 20)) then
			emul_rpc('onTogglePlayerSpectating', {false})
        end
        imgui.SameLine()
        if imgui.Button(u8'Войти в спектатор', imgui.ImVec2(240, 20)) then
			emul_rpc('onTogglePlayerSpectating', {true})
		end
		imgui.Text(u8'                                                                    ')
		imgui.SameLine()
		if imgui.Button(u8'Заспавниться', imgui.ImVec2(240, 20)) then
			sampSpawnPlayer()
			restoreCameraJumpcut()
		end
		imgui.SameLine()
		if imgui.Button(u8'Заспавниться (Эмуляция)', imgui.ImVec2(240, 20)) then
        ...
        imgui.Text(u8'                                                                    ')
		imgui.SameLine()
        -- if imgui.Button(u8'Показать курсор', imgui.ImVec2(240, 20)) then
        ...
        -- end
        -- imgui.SameLine()
        -- if imgui.Button(u8'Спрятать курсор', imgui.ImVec2(240, 20)) then
        --     local bs = raknetNewBitStream()
        --     raknetBitStreamWriteInt32(bs, 0xAAFF5656)
